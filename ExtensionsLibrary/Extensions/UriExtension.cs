...
namespace ExtensionsLibrary.Extensions {
	...
	public static partial class UriExtension {
		...
		public static string GetFileName(this Uri @this)
			=> Path.GetFileName(@this.OriginalString);
		...
		public static string GetFileNameWithoutExtension(this Uri @this)
			=> Path.GetFileNameWithoutExtension(@this.OriginalString);
		...
		public static bool ContainsAtExtension(this Uri @this, params string[] exts) => @this?.GetFileName().ContainsAtExtension(exts) ?? false;
